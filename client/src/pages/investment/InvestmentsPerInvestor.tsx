...
import { deleteInvestment, getAllInvestmentsPerInvestor } from '../../apiCalls/investmentApiCall';
...
const InvestmentsPerInvestor: React.FC = () => {
  ...
  useEffect(() => {
    if (!isInvestmentDeleted && investorId) {
      dispatch(getAllInvestmentsPerInvestor(investorId));
    }
...
export default InvestmentsPerInvestor;
