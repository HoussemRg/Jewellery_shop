...
const createCoupon=(coupon:CouponData):AppThunk<Promise<void>> =>{
    ...
    return async(dispatch:Dispatch,getState)=>{
        ...
        try{
            ...
            toast.update(id, { render: "Coupon created successfully", type: "success", isLoading: false, autoClose: 1200 });
        }catch(err){
...
const updateCoupon = (newCoupon:Partial<CouponEditData>,couponId:string):AppThunk<Promise<void>> => {
    ...
    return async (dispatch: Dispatch,getState: () => RootState) => {
        ...
        try {
            ...
            toast.update(id, { render: "Coupon updated successfully", type: "success", isLoading: false, autoClose: 1200 });
        } catch (err: unknown) {
            const error = err as AxiosError;
            if (id) {
                toast.update(id, { render: String(error?.response?.data) || 'An unknown error occurred', type: "error", isLoading: false, autoClose: 1200 });
...
const applyCoupon = (couponId:string,itemId:string):AppThunk<Promise<void>> => {
    ...
    return async (dispatch: Dispatch,getState: () => RootState) => {
        ...
        try {
            ...
            toast.update(id, { render: "Coupon applyied successfully", type: "success", isLoading: false, autoClose: 1200 });
        } catch (err: unknown) {
            const error = err as AxiosError;
            if (id) {
                toast.update(id, { render: String(error?.response?.data) || 'An unknown error occurred', type: "error", isLoading: false, autoClose: 1200 });
...
const deleteCoupon= (couponId:string):AppThunk<Promise<void>> => {
    ...
    return async (dispatch: Dispatch,getState: () => RootState) => {
        ...
        try {
            ...
            toast.update(id, { render: "Coupon deleted successfully", type: "success", isLoading: false, autoClose: 1200 });
        } catch (err: unknown) {
            const error = err as AxiosError;
            if (id) {
                toast.update(id, { render: String(error?.response?.data) || 'An unknown error occurred', type: "error", isLoading: false, autoClose: 1200 });
